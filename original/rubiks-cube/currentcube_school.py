...
def rightdown():
    ...
    while m<=53 and n<=40:
        if (positions1[n])[0] == facelets[m].pos.x and (positions1[n])[1] == facelets[m].pos.y and (positions1[n])[2] == facelets[m].pos.z:
            if debug is true:print(facelets[m].pos.x , (positions1[n+1])[0])  # Python 3 fix
            if debug is true:print(facelets[m].pos.y , (positions1[n+1])[1])  # Python 3 fix
            if debug is true:print(facelets[m].pos.z , (positions1[n+1])[2])  # Python 3 fix
