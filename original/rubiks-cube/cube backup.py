        ...
        for l in imaginary_list:
            if k.pos==l.pos:
                ...
                if correct_cubes_at_once == 2:
                    print("i got two at once")  # Python 3 fix
            else:
                return False
                break
    return True
    ...
    while solved_now!=True:
        if solved()==False:
            ...
            if moves == 1000000:
                million_moves+=1
                moves = 0
                print("still going after", million_moves, "million moves")  # Python 3 fix
            else:
                moves = moves+1
                if moves == 1000:
                    print(million_moves, "million","1000", "moves done with no avail")  # Python 3 fix
        else:
            print("I did it! in", million_moves, "million moves!")  # Python 3 fix
            solved_now = True
##while 1:
