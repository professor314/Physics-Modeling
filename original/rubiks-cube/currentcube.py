...
bottom = None  # Python 3 fix - incomplete assignment (work in progress)
top = None  # Python 3 fix - incomplete assignment (work in progress)
front = None  # Python 3 fix - incomplete assignment (work in progress)
back = None  # Python 3 fix - incomplete assignment (work in progress)
left = None  # Python 3 fix - incomplete assignment (work in progress)
