...
def right():
    ...
    positions1 = (pc1,pc5,pf1,pf5,pi1,pi5,pc5,pg3,pf5,pd3,pi5,pa3,pa2,pc2,pb2,pf2,pc2,pi2,pd2,pb2,pe2,pe2,pf2,ph2,pg2,pa2,ph2,pd2,pi2,pg2,pa3,pi6,pd3,pf6,pg3,pc6,pc6,pc1,pf6,pf1,pi6,pi1)
    faceletslistx = []
    faceletslisty = []
    faceletslistz = []
    sizes = []
...
##            facelets[m].size.y = (sizes[n+1])[2]
            ...
            if m != 53:
                ...
                m = 0
                n = n+2
    print("x = ",faceletslistx)  # Python 3 fix
    print("y = ",faceletslisty)  # Python 3 fix
    print("z = ",faceletslistz)  # Python 3 fix
    n=0
