---
title: "Rubik's Cube — Early Visual Draft"
author: Sean Connolly
date: 2004
course: Modeling Motion
original_file: Untitled Document.rtf
notes: "An early version of the Rubik's cube visualization using VPython boxes. This predates the class-based approach in best_cube.py. Contains planning comments for rotation functions."
---

# Rubik's Cube — Early Visual Draft

This is an early attempt at building the 3D Rubik's cube visualization. It manually creates 54 colored box faces (6 faces × 9 squares) positioned in 3D space, with planning comments for rotation functions that were later implemented in the final version.

> *See the completed versions at [original/rubiks-cube/](../../original/rubiks-cube/).*
...
a4= box(pos=(10,-2.5,12.5), size = (5,.01,5), color = color.blue) #blue side
...
b1= box(pos=(5,10,5), size = (5,5,.01), color = color.red) #red side
...
b4= box(pos=(5,-2.5,12.5), size = (5,.01,5), color = color.blue)#blue side
...
c1= box(pos=(10,10,5), size = (5,5,.01), color = color.red) #red side
...
c4= box(pos=(0,-2.5,12.5), size = (5,.01,5), color = color.blue)#blue side
...
d4= box(pos=(0,-2.5,7.5), size = (5,.01,5), color = color.blue)#blue side
...
> *This early approach of manually positioning 54 box objects was later replaced by the class-based design in `cube_class.py` and `best_cube.py`.*
